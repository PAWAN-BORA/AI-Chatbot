...
import { deleteChat } from "@/utils/chatFetch";
      ...
      <div className="mt-2">
        {sidebarList.map((item)=>{
          ...
          return(
            <div 
              key={item.chatId} 
              className={`my-0.5 p-1 flex justify-between items-center gap-2 hover:bg-primarygray ${chatId==item.chatId?"bg-primarygray":""}`}
            >
              <div
